...
<html lang="en">
	<head>
	    ...
	    <title>Mariga Online Shopping Store</title>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/slider.png);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/sliderr.png);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left"></h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#furniture" data-toggle="tab">Beauty Care</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
